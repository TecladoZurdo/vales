...
begin
//-- si el boton de eliminar está activo
  //-- presento el mensaje y si la respuesta es si
  //-- activo la impresión de lo contrario doy paso
  //-- libre a imprimir
  if(FVALE.XiButton6.Enabled) then
    begin
    //-- doy un mensage de advertencia que
    //-- se guardará el vale y la orden de pago
      if(messagebox(FORDPAGO.Handle,
      'Tanto el Vale como la Orden de pago se registrará en el programa si imprime'+'¿Desea imprimir?',
